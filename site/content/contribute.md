...
<label for="context">What else was going on in your life during this period? Other treatments, diet, lifestyle, stress, medications, environment. One sentence is enough. "Nothing else changed" is a valid answer.</label>
...
<label for="more">A detail, a longer story, something the form didn't ask?</label>
<textarea name="more" id="more" rows="3"></textarea>

---

<label for="display_name">Display name (optional — leave blank to appear anonymously)</label>
<input type="text" name="display_name" id="display_name" placeholder="Name, nickname, or leave blank">
...
*Every observation recorded is one that did not exist before.*
